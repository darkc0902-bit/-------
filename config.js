...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+917864886199', // Mettez votre numéro ici
    BOT_NAME: "LOVE XMD Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝐋𝐎𝐕𝐄  𝐗𝐌𝐃',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://i.imgur.com/qcE1kWQ.jpeg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7XzwO5K3zUDgR9Gz3o',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '7214172448:AAHGqSgaw-zGVPZWvl8msDOVDhln-9kExas',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '+917864886199'
